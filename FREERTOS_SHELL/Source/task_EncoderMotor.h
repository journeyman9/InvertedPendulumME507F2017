...
#ifndef TASK_ENCODERMOTOR_H
#define TASK_ENCODERMOTOR_H
...
class task_EncoderMotor : public frt_task{
	protected:
	
	public:
		// Constructor creates a motor encoder task object
		task_EncoderMotor(const char*, unsigned portBASE_TYPE, size_t, emstream*);
